        ...
        <div className="w-full max-w-2xl mx-auto text-center">
          ...
          <section className="my-12 p-8 bg-card border border-border rounded-2xl shadow-2xl text-center space-y-6 relative overflow-hidden">
              ...
              <div className="space-y-2 mt-4">
                <p className="text-2xl md:text-3xl font-bold">Você vai potencializar<br/>em até <span className="text-green-500">10X MAIS</span> o efeito<br/>das Frases Secretas</p>
              </div>
